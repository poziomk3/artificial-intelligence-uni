...
from lab1.optimized.a_star_fastest_route_pruned import a_star_fastest_route_pruned
...
if __name__ == "__main__":
    ...
    # a_star_fastest_route_pruned(graph, start_stop, end_stop, start_time, haversine_time_estimate)
    #
    # start_stop = "DWORZEC AUTOBUSOWY"
    # checkpoints = ["Kiełczów - pętla/Wrocławska", "EPI", "Vivaldiego", "Pułaskiego"]
    #
    # full_path, cost = tabu_search_b(graph, start_stop, checkpoints, "t", start_time)
    #
